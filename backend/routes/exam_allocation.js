...
router.get("/write-start-time/:user_id/:exam_id", ExamAllocationCtrl.writeStartTime);
router.get("/write-end-time/:user_id/:exam_id", ExamAllocationCtrl.writeEndTime);
